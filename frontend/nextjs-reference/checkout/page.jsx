  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 'success') {
        ...
        // In Next.js, we can pass state via query params or a state store.
        // For simplicity, we pass orderId in query parameter or mock success page.
        ...
        <form onSubmit={handlePlaceOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 text-xs bg-[#F7F3EF]/30 border border-[#CBAD8D]/25 focus:outline-none focus:border-[#A48374] rounded-2xl text-[#3A2D28]"
                  />
                </div>
            ...
            <div className="bg-white rounded-[28px] border border-[#E6DFD6] p-6 md:p-8 shadow-sm">
              ...
              <div 
                className="rounded-2xl p-6 border-2 border-dashed border-[#CBAD8D]/30 text-center space-y-3 bg-[#FBF9F6]"
              >
